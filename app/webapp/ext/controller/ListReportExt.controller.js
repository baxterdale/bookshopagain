sap.ui.define([
	...
	return sap.ui.controller("bookshopagain.main.ext.controller.ListReportExt", {
		...
		onCustomSupplierDialogOpen: function() {
			if (!this._oSupplierDialog) {
				this._oSupplierDialog = sap.ui.xmlfragment("bookshopagain.main.ext.fragment.CustomSupplierFilterSelectDialog", this);
			}
		...
		getCustomAppStateDataExtension: function(oCustomData) {
			...
			if (oCustomData) {
				...
				if (oSmartFilterBar instanceof SmartFilterBar) {
					...
					if (oCustomControl instanceof RatingIndicator) {
						oCustomData.AverageRatingValue = oCustomControl.getPrompt();
					}
		...
		_getRatingFilter: function(oRatingSelect) {
			var sRating = oRatingSelect.getPrompt(),
				oFilter;
			if (sRating > 0) {
